...
static struct mtd_partition rtl8196_parts1[] = {
        ...
        {
                name:           "root fs(bank1)",
                size:        (CONFIG_RTL_ACT_CONF_OFFSET-CONFIG_RTL_ROOT_IMAGE_OFFSET),
                offset:         (CONFIG_RTL_ROOT_IMAGE_OFFSET),
        },
        {
                name: "linux(bank2)",
	...
	{
		name: "act_conf",
		size: (CONFIG_RTL_FLASH_SIZE-CONFIG_RTL_ACT_CONF_OFFSET),
		offset: (CONFIG_RTL_FLASH_DUAL_IMAGE_OFFSET+CONFIG_RTL_ACT_CONF_OFFSET),
	},
#if 0
	{
		name: "reserved_boot",
		size: (CONFIG_RTL_WEB_PAGES_OFFSET-0),
		offset: (CONFIG_RTL_FLASH_DUAL_IMAGE_OFFSET+0),
	},
#endif
	{
		name: "reserved_conf",
		size: (CONFIG_RTL_FLASH_SIZE-CONFIG_RTL_ACT_CONF_OFFSET),
		offset: (CONFIG_RTL_ACT_CONF_OFFSET),
	}
