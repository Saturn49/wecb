...
#if !defined(AEI_WIFI_DISABLE_QOS_TRIPLAY_PATCH)
#define WMM_VOVIBE_PRI //classify VO, VI, and BE in 2.4G(92c) for actiontec with platform 98+92c+92d
#endif
#ifdef WMM_VOVIBE_PRI
	#define WMM_VIBE_PRI
#endif
...
#ifdef WMM_VOVIBE_PRI
#define NUM_TX_DESC     512 //acctiontec classify 3 traffic priority
#else
