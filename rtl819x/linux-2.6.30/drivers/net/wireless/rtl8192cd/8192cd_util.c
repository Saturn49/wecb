...
/* #define CONFIG_RTL_SET_CLIENT_STATIC_MAC 1 // configured in DEFINES */
#if defined(CONFIG_RTL_SET_CLIENT_STATIC_MAC)
#ifndef RTL865x_L2_TYPEII
...
extern int32 _rtl865x_delFilterDatabaseEntry(uint16 l2Type, uint16 fid, ether_addr_t * macAddr);
#endif
...
void init_stainfo(struct rtl8192cd_priv *priv, struct stat_info *pstat)
{
	...
	retval = _rtl865x_addFilterDatabaseEntry(RTL865x_L2_TYPEII, RTL_LAN_FID, (ether_addr_t *)pstat->hwaddr, FDB_TYPE_FWD, RTL_CPU_PORTMASK, TRUE, FALSE);
...
//yschen 2009-03-04
	...
	#if defined(CONFIG_RTL_SET_CLIENT_STATIC_MAC)
	local_irq_save(flags);
	retval = _rtl865x_delFilterDatabaseEntry(RTL865x_L2_TYPEII, RTL_LAN_FID, (ether_addr_t *)pstat->hwaddr);
	local_irq_restore(flags);
	#endif
#if 1
