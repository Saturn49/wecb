...
#else
//Jason_pin44_PCIErst
               REG32(0xb8000044) = (REG32(0xb8000044) & ~(7<<19)) |(7<<19);

                REG32(0xb8003500)=REG32(0xb8003500)&(~(1<<18));//which pin number

                 REG32(0xb8003508)= REG32(0xb8003508)|(1<<18);




                REG32(0xb800350C) &= ~(1<<18);    //perst=0 off.
                delay_ms(300);   //PCIE standadrd: poweron: 100us, after poweron: 100ms
                delay_ms(300);

                REG32(0xb800350C) |=  (1<<18);   //PERST=1
		...
		#endif
		{
			...
			HostPCIe_SetPhyMdioWrite(portnum, 4, 0x7000);
				...
				else //25MHz
				{
					...
					HostPCIe_SetPhyMdioWrite(portnum, 5, 0x0b13); //25M
