...
#define	RTL_WAN_1_VLANID		369
	...
	#define	RTL_LANPORT_MASK			0x110 //mark_inic , only port4 connect to MII
		...
		#endif
	#elif defined (CONFIG_8198_PORT5_GMII) || defined(CONFIG_AEI_MOCA_ENABLE)
        #define RTL_WANPORT_MASK                0x0  //port0 eth1
        #if defined(CONFIG_AEI_HW_WECB3000)
			#define RTL_LANPORT_MASK                        0x123 //port 0 1 5 8 are eth0
        #elif defined(CONFIG_AEI_HW_ECB3000)
			#define RTL_LANPORT_MASK                        0x121 //port 0 5 are eth0
        #elif defined(CONFIG_AEI_HW_JNR3000)
			#define RTL_LANPORT_MASK                        0x12f //port 0 1 2 3 5 8 are eth0
        #endif
	#else
	#define	RTL_WANPORT_MASK		0x10
	#define	RTL_LANPORT_MASK			0x10f
...
#if defined(CONFIG_RTK_VLAN_SUPPORT) || defined (CONFIG_RTL_MULTI_LAN_DEV)
#if defined(CONFIG_8198_PORT5_GMII) || defined(CONFIG_RTK_VLAN_NEW_FEATURE) || defined(CONFIG_AEI_MOCA_ENABLE)
	#define ETH_INTF_NUM	2	// LAN: eth0    MoCA: clink0
#else
