...
int br_del_bridge(struct net *net, const char *name)
{
	...
	{
		#ifdef AEI_WECB
		if (rtl_unregisterIgmpSnoopingModule(brIgmpModuleIndex) == SUCCESS)
			brIgmpModuleIndex = 0xFFFFFFFF;
		#else
	...
	{
		#ifdef AEI_WECB
		if (rtl_unregisterIgmpSnoopingModule(brIgmpModuleIndex_2) == SUCCESS)
			brIgmpModuleIndex_2 = 0xFFFFFFFF;
		#else
