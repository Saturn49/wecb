...
void sendEventMessage(unsigned char assigned, const char *ip, const char *mask, const char *gateway, const char *nameserver, int lease_time )
{
#ifdef AEI_TR111
    ...
    */
    ...
    if( assigned ) {
        ...
        tr69_commit_set_leaf_data( "Device.DHCPv4.Client.1.X_ACTIONTEC_COM_LeaseTime", (void *)&lease_time, TR69_NODE_LEAF_TYPE_INT);
        tr69_commit_set_leaf_data( "Device.DHCPv4.Client.1.X_ACTIONTEC_COM_LastChangeTime", (void *)&zero, TR69_NODE_LEAF_TYPE_UINT);
        tr69_commit_set_leaf_data( "Device.DHCPv4.Client.1.DHCPServer", (void **)gateway, TR69_NODE_LEAF_TYPE_STRING);
#ifdef AEI_SHOW_GATEWAY_MAC
         do{
             char mac[32] = {0};
             char macAddr[32] = {0};
