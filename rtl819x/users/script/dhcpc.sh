...
#	CMD="$CMD -n -a"
    ...
    # +++++ AEI_WECB +++++
	echo "cli -s Device.LAN.IPAddress string $IP_ADDR" >> $SCRIPTFILE_PATH/$PARAM1.deconfig
	echo "cli -s Device.LAN.SubnetMask string $SUBNET_MASK" >> $SCRIPTFILE_PATH/$PARAM1.deconfig
	echo "cli -s Device.LAN.DefaultGateway string $DEFAULT_GATEWAY" >> $SCRIPTFILE_PATH/$PARAM1.deconfig
    # ----- AEI_WECB -----
