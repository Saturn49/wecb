...
#ifdef ACTIONTEC_WCB
	else if(!strcmp(name, "UpgradesManaged"))
	{		
	    if(tr69GetUnfreshLeafData(UpgradesManaged, "Device.ManagementServer", "UpgradesManaged"))
	    {
	        printf("Get Device.ManagementServer.UpgradesManaged error!\n");      
	    }
	    return req_format_write(wp, "%s", UpgradesManaged);
	}
#endif	
#ifdef ACTIONTEC_WCB
