...
MIBDEF(unsigned char,   pin_disable_cfg_by_exreg, , PIN_DISABLE_CONFIG_BY_EXREG, BYTE_T, APMIB_T, 0,0)
MIBDEF(unsigned char,   max_pin_fail_threshold, , MAX_PIN_FAIL_THRESHOLD, BYTE_T, APMIB_T, 0,0)
#endif
