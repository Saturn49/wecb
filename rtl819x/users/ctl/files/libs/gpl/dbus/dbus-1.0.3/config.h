...
#define DBUS_UINT64_PRINTF_MODIFIER "lu"        //add
...
#define DBUS_LIBEXECDIR "/var/libexec"
...
#define DBUS_SYSTEM_BUS_DEFAULT_ADDRESS "unix:path=/var/dbus/system_bus_socket"
...
#define DBUS_SYSTEM_SOCKET "/var/dbus/system_bus_socket"

/* Full path to the launch helper test program in the builddir */
//#define DBUS_TEST_LAUNCH_HELPER_BINARY "/home/actiontec/source/dbus-1.4.0/bus/dbus-daemon-launch-helper-test"
#define DBUS_TEST_LAUNCH_HELPER_BINARY "/bin/dbus-daemon-launch-helper-test"
...
#define TEST_BUS_BINARY "/home/actiontec/source/dbus-1.4.0/bus/dbus-daemon"

/* Full path to test file test/test-exit in builddir */
#define TEST_EXIT_BINARY "/home/actiontec/source/dbus-1.4.0/test/test-exit"

/* Full path to test file test/data/invalid-service-files in builddir */
#define TEST_INVALID_SERVICE_DIR "/home/actiontec/source/dbus-1.4.0/test/data/invalid-service-files"

/* Full path to test file test/data/invalid-service-files-system in builddir
   */
#define TEST_INVALID_SERVICE_SYSTEM_DIR "/home/actiontec/source/dbus-1.4.0/test/data/invalid-service-files-system"

/* Full path to test file test/name-test/test-privserver in builddir */
#define TEST_PRIVSERVER_BINARY "/home/actiontec/source/dbus-1.4.0/test/name-test/test-privserver"

/* Full path to test file test/test-segfault in builddir */
#define TEST_SEGFAULT_BINARY "/home/actiontec/source/dbus-1.4.0/test/test-segfault"

/* Full path to test file test/test-service in builddir */
#define TEST_SERVICE_BINARY "/home/actiontec/source/dbus-1.4.0/test/test-service"

/* Full path to test file test/test-shell-service in builddir */
#define TEST_SHELL_SERVICE_BINARY "/home/actiontec/source/dbus-1.4.0/test/test-shell-service"

/* Full path to test file test/test-sleep-forever in builddir */
#define TEST_SLEEP_FOREVER_BINARY "/home/actiontec/source/dbus-1.4.0/test/test-sleep-forever"

/* Full path to test file test/data/valid-service-files in builddir */
#define TEST_VALID_SERVICE_DIR "/home/actiontec/source/dbus-1.4.0/test/data/valid-service-files"

/* Full path to test file test/data/valid-service-files-system in builddir */
#define TEST_VALID_SERVICE_SYSTEM_DIR "/home/actiontec/source/dbus-1.4.0/test/data/valid-service-files-system"
